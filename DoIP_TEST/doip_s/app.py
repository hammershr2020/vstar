...
L1 = [[sg.Text("・IPアドレス "			,size=(20,1)),
	...
	sg.InputText(default_text="4e4554414002" ,	text_color = "#000000",background_color ="#ffffff" ,	size=(40,1),	key="-EID_GW-" )],
	[sg.Text("・VIN "				,size=(20,1)),
	sg.InputText(default_text="4c56564443313142364144333234323836" ,	text_color = "#000000",background_color ="#ffffff" ,		size=(40,1),		key="-VIN_GW-" )],
