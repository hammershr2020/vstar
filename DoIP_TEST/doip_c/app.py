...
L1 = [
	# 診断機設定
	[sg.Text("・IP 地址 "),
	sg.InputText(default_text="172.16.1.60" , text_color = "#000000",background_color ="#ffffff",		size=(15,1),	key="-IP_EQP-" ),
	sg.Text("     ")],
	[sg.Text("・端口号 "),
	sg.InputText(default_text=src_port,	text_color = "#000000",background_color ="#ffffff" ,		size=(8,1),		key="-PORT_EQP-" )]]

	# ＧＷ設定
L2 = [
	[sg.Text("・IP 地址 "),
	sg.InputText(default_text="172.16.1.20" , text_color = "#000000",background_color ="#ffffff" ,	size=(15,1),	key="-IP_GW-" ),
	sg.Text("     ")],
	[sg.Text("・端口号 "),
...
# UDP
L4 = [[sg.Button("发送", border_width=4 ,												size =(15,1),	key="-BTN_SEND_UDP-")],			# ボタン
	...
	[sg.Text("・EID", size=(10,1)) , sg.InputText(default_text="4e4554414002" ,			size=(23,1) ,	key="-TXT_EID-")],
	...
	[sg.Text("・VIN", size=(10,1)) , sg.InputText(default_text="4c56564443313142364144333234323836" ,	size=(40,1) ,	key="-TXT_VIN-")],
...
# TCP
L5 = [[sg.Button("连接", border_width=4 , 												size =(15,1),	key="btn_connect_tcp"),				# ボタン
	sg.Button("断开连接", border_width=4 , 												size =(15,1),	key="btn_close_tcp"),				# ボタン
	sg.Button("发送", border_width=4 , 													size =(15,1),	key="btn_send_tcp")],				# ボタン
	## Routing activation request
	[sg.Radio(text='Routing activation request',										size=(52,1) ,	key="-CMD_TCP_RA_REQ-"	,	group_id='CMD_TCP') ],
	[sg.Text("・SA", size=(10,1)) , sg.InputText(default_text="0e80" ,					size=(7,1) ,	key="-TXT_SA1-")],
	## Alive check request
	...
	[sg.Text("・SA", size=(10,1)) , sg.InputText(default_text="0e80" ,					size=(7,1) ,	key="-TXT_SA2-"),
	sg.Text("・TA", size=(7,1)) , sg.InputText(default_text="1040" ,					size=(7,1) ,	key="-TXT_TA-")],
...
L = [[sg.Frame("DoIP客户端（诊断机）",L1),sg.Frame("DoIP服务器（网关）",L2)],
	[sg.Frame("UDP",L4),sg.Frame("TCP",L5)],
	[sg.Frame("通信状态",L3)]]

# ウィンドウ作成
window = sg.Window ("DoIP client tool", L)
values = ""
...
def tcp_send( data ):
	...
	try:
		...
		ready = select.select([tcpClntSock], [], [], timeout_in_seconds)
		if ready[0]:
